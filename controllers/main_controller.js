...
module.exports.retrieveData = function (req,res){
    ...
    var start = req.query.start ? req.query.start : 1475419531;
    var end = req.query.end ? req.query.end : 1476543246;
    var interval = req.query.interval ? req.query.interval : "1d";
